    ...
    return LaunchDescription([
        ...
        ExecuteProcess(
            cmd=['ros2', 'run', 'ros_gz_bridge', 'parameter_bridge',
                 ...
                 '/world/world_demo/model/x500_depth_0/model/oakd_lite_camera_5/link/camera_link/sensor/IMX214/camera_info@sensor_msgs/msg/CameraInfo@gz.msgs.CameraInfo',
                 '/world/world_demo/model/x500_depth_0/model/oakd_lite_camera_5/link/camera_link/sensor/IMX214/image@sensor_msgs/msg/Image@gz.msgs.Image',
                 '/world/world_demo/model/x500_depth_0/model/oakd_lite_camera_5/link/camera_link/sensor/StereoOV7251/depth_image@sensor_msgs/msg/Image@gz.msgs.Image',
        ...
        Node(
            package='tf2_ros', 
            executable='static_transform_publisher',
            name='rgb_camera_5_tf',
            arguments=['--x', '0', '--y', '0', '--z', '0.1', 
                    '--roll', '0', '--pitch', '3.1416', '--yaw', '1.5708',
                    '--frame-id', 'base_link', '--child-frame-id', 'x500_depth_0/oakd_lite_camera_5/camera_link/IMX214']
        ),
        ...
        Node(
            package='tf2_ros', 
            executable='static_transform_publisher',
            name='depth_camera_5_tf',
            arguments=['--x', '0', '--y', '0', '--z', '0.1', 
                    '--roll', '0', '--pitch', '3.1416', '--yaw', '1.5708',
                    '--frame-id', 'base_link', '--child-frame-id', 'x500_depth_0/oakd_lite_camera_5/camera_link/StereoOV7251']
        ),
        ...
        Node(
            ...
            remappings=[
                ('rgb/image', '/world/world_demo/model/x500_depth_0/model/oakd_lite_camera_5/link/camera_link/sensor/IMX214/image'),
                ('rgb/camera_info', '/world/world_demo/model/x500_depth_0/model/oakd_lite_camera_5/link/camera_link/sensor/IMX214/camera_info'),
                ('depth/image', '/world/world_demo/model/x500_depth_0/model/oakd_lite_camera_5/link/camera_link/sensor/StereoOV7251/depth_image'),
