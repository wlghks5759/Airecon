	...
	: Node("aruco_detector_node")
{
	...
	_image_sub = this->create_subscription<sensor_msgs::msg::Image>(
			     "/world/world_demo/model/x500_gimbal_0/model/oakd_lite_camera_5/link/camera_link/sensor/IMX214/image", qos, std::bind(&Aruco_DetectorNode::image_callback, this, std::placeholders::_1));

	_camera_info_sub = this->create_subscription<sensor_msgs::msg::CameraInfo>(
				   "/world/world_demo/model/x500_gimbal_0/model/oakd_lite_camera_5/link/camera_link/sensor/IMX214/camera_info", qos, std::bind(&Aruco_DetectorNode::camera_info_callback, this, std::placeholders::_1));
